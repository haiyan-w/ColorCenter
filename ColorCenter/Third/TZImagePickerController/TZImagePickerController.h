...
///// Default value is false/ 是否需要限制可选视频时长
//@property (assign, nonatomic) BOOL allowLimitPickedVideoDuration;

/// Default value is 30 seconds / 可选视频最长时间（s），.默认0 ，不作限制,  > 0才起作用
@property (assign, nonatomic) NSTimeInterval pickVideoMaximumDuration;
