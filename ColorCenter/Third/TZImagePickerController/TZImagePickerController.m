...
//    self.photoDefImageName = @"photo_def_photoPickerVc";
    self.photoSelImageName = @"photo_sel";
    self.photoDefImageName = @"clear";
...
-(void)setPickVideoMaximumDuration:(NSTimeInterval)pickVideoMaximumDuration
{
    _pickVideoMaximumDuration = pickVideoMaximumDuration;
    [TZImagePickerConfig sharedInstance].pickVideoMaximumDuration = pickVideoMaximumDuration;
}
